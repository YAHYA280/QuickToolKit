...
const linkClass = "text-background/80 transition-colors hover:bg-highlight hover:text-highlight-foreground";
  ...
  return (
    <footer className="mt-24 border-t-2 border-foreground bg-foreground text-background">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
        ...
        <div>
          <p className="font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-background/60">{t("categories")}</p>
        ...
        <div>
          <p className="font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-background/60">Popular</p>
          <ul className="mt-3 space-y-2 text-sm">
            {tools
        ...
        <div>
          <p className="font-mono text-[11px] font-bold uppercase tracking-[0.12em] text-background/60">{t("company")}</p>
          <ul className="mt-3 space-y-2 text-sm">
            {[
              ["/about", nav("about")],
              ["/contact", nav("contact")],
      ...
      <div className="border-t border-background/20">
        <p className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 font-mono text-[11px] text-background/60">
          <span>
